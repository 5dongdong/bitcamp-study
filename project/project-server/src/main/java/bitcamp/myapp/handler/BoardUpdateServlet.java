...
public class BoardUpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			board.setCategory(Integer.parseInt(req.getParameter("category")));

			String uploadDir = req.getServletContext().getRealPath("upload/board");
			...
			if (InitServlet.boardDao.update(board) == 0) {
				...
				resp.setHeader("refresh", "1;url=/board/list?category=" + board.getCategory());
			}
