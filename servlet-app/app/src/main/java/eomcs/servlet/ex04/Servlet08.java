...
public class Servlet08 extends GenericServlet {
	...
	public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
		...
		Thumbnails.of(this.uploadDir + "/" + filename).size(80, 80).outputFormat("jpg").crop(Positions.CENTER)
		...
		Thumbnails.of(this.uploadDir + "/" + filename).size(160, 160).outputFormat("jpg").crop(Positions.CENTER)
				// .toFiles(Rename.PREFIX_DOT_THUMBNAIL);
				.toFiles(new Rename() {
					@Override
					public String apply(String name, ThumbnailParameter param) {
